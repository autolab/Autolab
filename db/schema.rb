...
ActiveRecord::Schema.define(version: 20171228095028) do
  ...
  add_index "oauth_device_flow_requests", ["device_code"], name: "index_oauth_device_flow_requests_on_device_code", unique: true
  add_index "oauth_device_flow_requests", ["user_code"], name: "index_oauth_device_flow_requests_on_user_code", unique: true
