...
RSpec.describe Api::V1::AssessmentsController, type: :controller do
  describe "GET #index" do
    ...
    it "fails to find the course" do
      get :index, params: { access_token: token.token, course_name: 8.times.map do
                                                                      rand(65..90).chr
                                                                    end.join } # random course name
  ...
  describe "GET #problems" do
    ...
    it "returns all the problems of an assignment" do
      get :problems,
          params: { access_token: token.token, course_name: course.name,
