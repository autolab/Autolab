...
private
  ...
  def verify_dates_order
    errors.add :start_at, "must be before the due at date" if start_at > due_at
    errors.add :due_at, "must be before the end at date" if due_at > end_at
    errors.add :end_at, "must be before the grading deadline" if end_at > grading_deadline
  end
