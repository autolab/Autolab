...
class SubmissionsController < ApplicationController
    ...
    if params[:header_position]
      ...
      Prawn::Document.generate(@filename_annotated, template: @filename) do |pdf|
        @annotations.each do |annotation|
          ...
          value = "N/A"
          value = annotation.value unless annotation.value.blank?
  ...
  def view
    ...
    unless PDF.pdf?(file)
      ...
      begin
        ...
        while i < @ctags_json.length
          ...
          if ((obj_temp["kind"] == "function") || (obj_temp["kind"] == "method")) && (@ctag_obj.select do |ctag|
    ...
    @prevSubmission = @curSubmissionIndex.positive? ? @latestSubmissions[@curSubmissionIndex - 1] : nil
