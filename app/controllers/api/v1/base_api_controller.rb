  ...
  module V1
    ...
    protected
      ...
      class ApiLogger
        ...
        def self.log(level, msg)
          ...
          Rails.logger.send(level) do
            "#{level.upcase} -- #{strTime} -- #{@ip} C#{@client_id} U#{@user_id} -- #{msg}"
          end
        end
      end
      ...
      def require_privilege(scope)
        ...
        when :instructor_all
          ...
          unless @cud.instructor
            raise ApiError.new("User does not have instructor privileges for this course",
                               :forbidden)
          end
        end
      end
      ...
      def set_course
        ...
        raise ApiError.new("Course does not exist", :not_found) unless @course
      ...
      def authorize_user_for_course
        ...
        raise ApiError.new("User is not in this course", :forbidden) unless @cud
      ...
      def set_assessment
        ...
        raise ApiError.new("Assessment does not exist", :not_found) unless @assessment
